...
if(isset($_GET["q"]) && !isset($_GET["v"])){
	if(isset($_GET["alt"])){header("Location: https://" . $baseURL ."/TubeRepair/WindowsPhone/WPChannelSearch.php?q=" . $_GET["q"]);}
...
if($kindResponse == "youtube#searchListResponse"){
	...
	$entry = <<<Entry
		...
		<link rel='http://$baseURL/schemas/2007#featured-video' type='application/atom+xml' href='https://$baseURL/feeds/api/videos/YM582qGZHLI?v=2'/>
		<link rel='alternate' type='text/html' href='https://www.youtube.com/channel/UCs3JgJcFG2o-NH3T63vo-qg'/>
		<link rel='self' type='application/atom+xml' href='https://$baseURL/feeds/api/channels/s3JgJcFG2o-NH3T63vo-qg?v=2'/>
		<author>
			<name>$channelname</name>
			<uri>https://$baseURL/feeds/api/users/webauditors</uri>
			<yt:userId>s3JgJcFG2o-NH3T63vo-qg</yt:userId>
		</author>
		<yt:channelId>$channelId</yt:channelId>
		<yt:channelStatistics subscriberCount='0' viewCount='0'/>
		<gd:feedLink rel='http://$baseURL/schemas/2007#channel.content' href='https://$baseURL/feeds/api/users/webauditors/uploads?v=2' countHint='0'/>
...
<feed
	...
	<link rel='http://schemas.google.com/g/2006#spellcorrection' type='application/atom+xml' href='https://$baseURL/feeds/api/channels?q=web+auditors&amp;start-index=1&amp;max-results=1&amp;oi=spell&amp;spell=1&amp;v=2' title='web auditors'/>
	<link rel='http://schemas.google.com/g/2005#feed' type='application/atom+xml' href='https://$baseURL/feeds/api/channels?v=2'/>
	<link rel='http://schemas.google.com/g/2005#batch' type='application/atom+xml' href='https://$baseURL/feeds/api/channels/batch?v=2'/>
	<link rel='self' type='application/atom+xml' href='https://$baseURL/feeds/api/channels?q=webauditors&amp;start-index=1&amp;max-results=1&amp;v=2'/>
	<link rel='service' type='application/atomsvc+xml' href='https://$baseURL/feeds/api/channels?alt=atom-service&amp;v=2'/>
	//<link rel='next' type='application/atom+xml' href='https://$baseURL/feeds/api/channels?q=webauditors&amp;start-index=2&amp;max-results=1&amp;v=2'/>
	<author>
		<name>YouTube</name>
