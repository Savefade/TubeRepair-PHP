...
if($kindResponse == "youtube#commentThreadListResponse"){
	...
	$text = str_replace(['&', '<', '>', '\u003', '&lt;','br&gt;'], ['&amp;', '&lt;', '&gt;', '', '', '', ''], $decodeResponce['items'][$i]['snippet']['topLevelComment']['snippet']['textDisplay']);
	//             "textDisplay": "It could be Sakura, Makoto, Yun and Yang, Dudley, Rose, Guy, Cody, Hagar, Poison, Hugo, Menat...so many fan favorites...\u003cbr\u003eBut we got Ed. \u003cbr\u003e\u003cbr\u003eEh.",
...
<entry gd:etag='$etag'>
		...
		<category scheme='http://schemas.google.com/g/2005#kind' term='http://$baseURL/schemas/2007#comment'/>
		<title>Comment from $channelname</title>
		<content>﻿$text</content>
		<link rel='related' type='application/atom+xml' href='http://$baseURL/feeds/api/videos/$commentVideoId?v=2'/>
		<link rel='alternate' type='text/html' href='http://www.youtube.com/watch?v=$commentVideoId'/>
		<link rel='self' type='application/atom+xml' href='http://$baseURL/feeds/api/videos/$commentVideoId/comments/$commentID?v=2'/>
		<author>
