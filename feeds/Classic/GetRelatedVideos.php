<?php 
include "../../Config.php";
if(isset($_GET["title"]) ||  str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.0") ||  str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.1")||  str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.2")||  str_contains($_SERVER["HTTP_USER_AGENT"], "Apple")){
...
$curlConnectionInitialization = curl_init("https://" . $APIurl . "/youtube/v3/search?part=snippet&maxResults=" . $MaxCount . "&q=" . preg_replace('/\s+/', '', $_GET["title"]) ."&type=video&orderby=$getsortby&key=" . $APIkey);
